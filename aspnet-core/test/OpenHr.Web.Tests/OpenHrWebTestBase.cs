...
{
    public abstract class OpenHrWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OpenHrWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OpenHrWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OpenHrDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OpenHrDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OpenHrDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OpenHrDbContext, Task<T>> func)
        {
            T result;
