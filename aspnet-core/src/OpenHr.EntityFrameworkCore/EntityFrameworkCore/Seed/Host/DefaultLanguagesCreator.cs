...
namespace OpenHr.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly OpenHrDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = OpenHrConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OpenHrDbContext context)
        {
            _context = context;
        }
